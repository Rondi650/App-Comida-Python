...
class Restaurante:
    ...
    def listar_restaurantes(cls):
        print(f'{'Nome do restaurante'.ljust(25)} | {'Categoria'.ljust(25)} | {'Avaliacoes'.ljust(25)} |{'Status'}')
    ...
    def receber_avaliacao(self, cliente, nota):
        nota_cliente = Avaliacao(cliente, nota)
        self._avaliacao.append(nota_cliente)
